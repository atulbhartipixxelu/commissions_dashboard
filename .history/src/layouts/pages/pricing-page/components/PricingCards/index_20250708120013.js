  ...
  monthly: [
    {
      ...
      features: [
        ...
        { label: "Limited Access", includes: true },
        { label: "Basic Support", includes: true },
        { label: "Basic Support", includes: true },
        { label: "Limited Access", includes: true },
        { label: "Basic Support", includes: true },
...
X Employee Target Set Up
    ...
    },
    {
      ...
      badgeColor: "info",
      features: [
        { label: "Premium Support", includes: true },
        { label: "Full Access", includes: true },
    ...
    },
    {
      ...
      badgeColor: "warning",
      features: [
        { label: "Basic Support", includes: false },
        { label: "Limited Access", includes: true },
      ],
    },
  ],
